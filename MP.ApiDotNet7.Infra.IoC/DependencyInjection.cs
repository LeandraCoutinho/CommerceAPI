...
using MP.ApiDotNet7.Application.Mapping;
using MP.ApiDotNet7.Application.Services;
using MP.ApiDotNet7.Application.Services.Interfaces;
using MP.ApiDotNet7.Domain.Authentication;
using MP.ApiDotNet7.Domain.Integrations;
using MP.ApiDotNet7.Domain.Repositories;
using MP.ApiDotNet7.Infra.Data.Authentication;
using MP.ApiDotNet7.Infra.Data.Context;
using MP.ApiDotNet7.Infra.Data.Integrations;
using MP.ApiDotNet7.Infra.Data.Repositories;

namespace MP.ApiDotNet7.Infra.IoC;
